...
export const Route = createFileRoute("/login")({
  head: () => ({ meta: [{ title: "Masuk — Agri Trend DSS" }] }),
  component: Login,
});

function Login() {
  const navigate = useNavigate();
  const [email, setEmail] = useState("petani@demo.id");
    ...
    <div className="grid min-h-screen lg:grid-cols-2">
      <div className="relative hidden overflow-hidden bg-[image:var(--gradient-hero)] p-12 text-primary-foreground lg:flex lg:flex-col lg:justify-between">
        ...
        <div className="relative">
          <h2 ref={headingRef} style={{ opacity: 0 }} className="text-4xl font-bold leading-tight">
            Prediksi panen lebih cerdas, keputusan lebih percaya diri.
          </h2>
          <p ref={subtextRef} style={{ opacity: 0 }} className="mt-4 text-primary-foreground/80">
            Bergabung dengan petani Indonesia yang sudah memanfaatkan AI untuk merencanakan musim
            tanam.
          </p>
      ...
      <div className="flex flex-col justify-center px-6 py-12 sm:px-12 lg:px-16">
        ...
        <div className="mx-auto w-full max-w-md">
          ...
          >
            Masuk untuk mengakses dashboard prediksi Anda.
          </p>
